...
- Edit text files from the viewer

### Behind the scenes

- Give 0.4.9 its place in the changelog
...
- Add the Default apps screen to the changelog
...
[Unreleased]: https://github.com/techhonar/File-Manager/compare/v0.4.9...HEAD
